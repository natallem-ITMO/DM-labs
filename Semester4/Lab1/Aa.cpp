...
unsigned divv(unsigned acc, unsigned a, unsigned q) {

    long long unsigned aa = (a * q);
    aa %= mode;
    long long aaa = acc;
...
int main() {
    ...
    unsigned long long int a = mode - 2;
    unsigned long long aa = 5 * a;
    long long unsigned b = (12 + 5 * a + 2);
//    long long unsigned b = a * 4;
    long long int dd = b % mode;
    int degP, degQ;
    cin >> degP >> degQ;
